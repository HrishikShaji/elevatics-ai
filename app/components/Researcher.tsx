			...
			<div className="flex flex-col items-center h-full pt-[200px] w-full">
				...
				<div className="w-[50%] flex flex-col gap-10">
					<form
						...
						className="mt-10 flex items-center relative w-full"
					>
						<input
							value={input}
					...
					{isLoading ? (
						<div className="w-10 mt-[100px]">
							<Spinner />
						</div>
					) : null}
					{isSuccess ? (
						<div className="flex flex-col gap-1 w-full">
							<span className="text-[#535353] mt-5">
								Here are some suggestions
							</span>
							<div className="p-10 md:p-0 w-full flex flex-col gap-1 mt-5">
